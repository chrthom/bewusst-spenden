...
export class DataService {
  private poverty: Organization[] = [
    {
      ...
      taxDeductable: true,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/against-malaria-foundation/',
      category: [ 'Armut' ],
      cause: [ 'Menschenleben' ],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/malaria-consortium/',
      category: [ 'Armut' ],
      cause: [ 'Menschenleben' ],
      impactDirection: 'reaktiv',
    ...
    },
    {
      ...
      donationLink: 'https://schistosomiasiscontrolinitiative.org/make-a-donation',
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34677',
      category: [ 'Armut' ],
      cause: [ 'Gesundheit' ],
      impactDirection: 'reaktiv',
    ...
    */
    {
      ...
      donationLink: 'https://donate.givedirectly.org/',
      taxDeductable: false,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/givedirectly/',
      category: [ 'Armut' ],
  ...
  private existentialRisks: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34692',
      category: [ 'Existenzrisiken' ],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/clean-air-task-force/',
      category: [ 'Existenzrisiken' ],
      cause: [ 'Klimaschutz' ],
      impactDirection: 'reaktiv',
      regions: [ 'US' ],
    ...
    },
    {
      ...
      donationLink: 'https://www.rainforestcoalition.org/donate/',
      taxDeductable: false,
      donationLink3rdParty: null,
      category: [ 'Existenzrisiken' ],
      cause: [ 'Klimaschutz' ],
  ...
  private meta: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34675',
      category: [ 'Meta' ],
      cause: [ 'Wirksamkeitsanalyse' ],
      impactDirection: 'reaktiv',
      regions: [],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34695',
      category: [ 'Meta' ],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34694',
      category: [ 'Meta' ],
      cause: [ 'Öffentlichkeitsarbeit' ],
      impactDirection: 'proaktiv',
      regions: [],
    ...
    },
    {
      ...
      taxDeductable: true,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34690',
      category: [ 'Meta' ],
      cause: [ 'Öffentlichkeitsarbeit' ],
      impactDirection: 'proaktiv',
      regions: [ 'DE' ],
  ...
  private animals: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/the-good-food-institute/',
      category: [ 'Tierleid' ],
      cause: [ 'Tierleben' ],
      impactDirection: 'proaktiv',
      regions: [],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://www.effektiv-spenden.org/the-humane-league/',
      category: [ 'Tierleid' ],
    ...
    },
    {
      ...
      taxDeductable: true,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34683',
      category: [ 'Tierleid' ],
      cause: [ 'Haltungsbedingungen', 'Tierleben' ],
      impactDirection: 'proaktiv',
      regions: [ 'DE', 'PL' ],
