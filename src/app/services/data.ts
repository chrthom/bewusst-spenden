    ...
    },
{
      ...
      donationLink: 'https://www.paypal.com/webapps/shoppingcart?flowlogging_id=4674ebaa66a4b&mfid=1535383030972_4674ebaa66a4b#/checkout/openButton',
      category: [ 'Armut' ],
      cause: [ 'Bildung' ],
      impactDirection: 'reactive',
      regions: [ 'Afrika' ],
      questionaireResults: [],
      slogan: 'Educating children in rural Ghana',
      shortDescription: 'The mission of the Ghana Scholarship Fund Inc. is to educate children in rural Ghana, West Africa whose parents can’t afford to pay the required tuition fees. ',
      longDescription: 'The mission of the Ghana Scholarship Fund Inc. is to educate children in rural Ghana, West Africa whose parents can’t afford to pay the required tuition fees.  They provide scholarships to  high school and university and support a local preschool/kindergarten and a girls vocational training school. In addition, they provide online academic tutorial learning for students of all ages in all subjects by creating computer labs and donating computers loaded with 178 gigabytes of online academic tutorials in order to enhance classroom learning and knowledge of computers and technology.',
      impact1000: '',
      donationDeficit: null,
      evaluators: []
    },
    ...
    },
    {
      ...
      slogan: 'Safeguarding the world against the worst impacts of climate change.',
    ...
    },
    {
      ...
      questionaireResults: ['environment'],
      slogan: 'responsible stewardship of the World’s last great rainforests.',
      shortDescription: 'The Coalition for Rainforest Nations seek responsible stewardship of the World’s last great rainforests through innovative strategies which integrate social, economic and scientific rationales to achieve environmental sustainability.',
      ...
      impact1000: 'Avert the equivalent of 8,500 tonnes of CO2 being released',
      donationDeficit: 2000000,
      evaluators: []
    },
    {
      ...
      impact1000: 'Avert the equivalent of 800 tonnes of CO2 being released',
      donationDeficit: null,
      evaluators: []
    },
