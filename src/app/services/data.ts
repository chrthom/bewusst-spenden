...
export class DataService {
  private poverty: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33723',
      category: [ 'Armut' ],
      cause: [ 'Gesundheit' ],
      impactDirection: 'reaktiv',
  ...
  private existentialRisks: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33729',
      category: [ 'Existenzrisiken' ],
  ...
  private meta: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33722',
      category: [ 'Meta' ],
      cause: [ 'Wirksamkeitsanalyse' ],
      impactDirection: 'reaktiv',
      regions: [],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33732',
      category: [ 'Meta' ],
    ...
    },
    {
      ...
      taxDeductable: false,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33731',
      category: [ 'Meta' ],
      cause: [ 'Öffentlichkeitsarbeit' ],
      impactDirection: 'proaktiv',
      regions: [],
    ...
    },
    {
      ...
      taxDeductable: true,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=33728',
      category: [ 'Meta' ],
      cause: [ 'Öffentlichkeitsarbeit' ],
      impactDirection: 'proaktiv',
      regions: [ 'DE' ],
  ...
  private animals: Organization[] = [
    ...
    },
    {
      ...
      taxDeductable: true,
      donationLink3rdParty: 'https://effektiveraltruismus.de/spenden/?fb_item_id_fix=34302',
      category: [ 'Tierleid' ],
      cause: [ 'Haltungsbedingungen', 'Tierleben' ],
      impactDirection: 'proaktiv',
      regions: [ 'DE', 'PL' ],
